...
for seed in seeds:
    ...
    for dset in keys:
        ...
        print(data[dset])
        SAVE_PATH = f"saves_complex/{TASK}/{seed}/"
        ...
        if os.path.exists(SAVE_PATH):
            ...
            if not os.path.exists(f"saves_complex/{TASK}"):
                os.mkdir(f"saves_complex/{TASK}")
            if not os.path.exists(f"saves_complex/{TASK}/{seed}"):
                os.mkdir(f"saves_complex/{TASK}/{seed}")
